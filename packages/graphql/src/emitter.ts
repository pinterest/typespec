...
/**
 * Phase 3: Render the mutated schema to GraphQL SDL.
 *
 * Stub in this PR — does nothing. The component-based Alloy renderer that
 * consumes `mutated` is implemented in a follow-up PR.
 */
function renderSchema(_mutated: MutatedSchema): void {}
